...
public class ServerSentEventController {
    private final Flux<com.example.reactiveapi.ProfileCreatedEvent> events;
    private final ObjectMapper objectMapper;

    public ServerSentEventController(com.example.reactiveapi.ProfileCreatedEventPublisher eventPublisher, ObjectMapper objectMapper) {
